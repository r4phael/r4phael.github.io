...
#Csv Results Frames:
results_frame <- read.csv(file = "~/R/analysis/results/Okhttp_resultsRqsBugsIns.csv", stringsAsFactors = FALSE)

#Csv Methods Time Series Total:
methods <- read.csv(file = "~/R/analysis/results_methods/Okhttp_totalTs.csv", stringsAsFactors = FALSE)

project <- "Okhttp"

#Project
results_frame$Project <- "Okhttp"
...
methods_insertions <-
  read.csv(
    "~/R/analysis/results_insertions/Okhttp_insertionTs.csv",
