...
#Csv Results Frames:
results_frame <- read.csv(file = "~/R/analysis/results/Fresco_resultsRqsBugsIns.csv", stringsAsFactors = FALSE)

#Csv Methods Time Series Total:
methods <- read.csv(file = "~/R/analysis/results_methods/Fresco_totalTs.csv", stringsAsFactors = FALSE)

#Project
project <- "Fresco"

results_frame$Project <- "Fresco"
...
methods_insertions <-
  read.csv(
    "~/R/analysis/results_insertions/Fresco_insertionTs.csv",
